/*
  ...
  - You are about to drop the column `text_uk` on the `Sales` table. All the data in the column will be lost.
  ...
  - Added the required column `name_uk` to the `Sales` table without a default value. This is not possible if the table is not empty.
